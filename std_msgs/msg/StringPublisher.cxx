...
bool StringPublisher::init()
{
    ...
    std::cout << "std_msgs::msg::String DataWriter created." << std::endl;
    return true;
}

void StringPublisher::PubListener::on_publication_matched(
...
{
    std::cout << "std_msgs::msg::String DataWriter waiting for DataReaders." << std::endl;
